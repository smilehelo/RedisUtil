...
public interface RedisOperator {
    ...
    void scan(String pattern, int pageCnt, Consumer<String> consumer);

    String set(String key, byte[] bytes);
    ...
    byte[] hgetbyte(String key, String field);
    ...
    List<byte[]> hmgetbyte(String key, String... fields);
     ...
     */
    void subscribe(Consumer<Tuple2<String, String>> consumer, String... channels);

    /**
     * pipeline
     *
     * @param consumer pipeline consumer
     */
    void pipeline(Consumer<Pipeline> consumer);
